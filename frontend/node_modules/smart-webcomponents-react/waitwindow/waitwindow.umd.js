...
(function (global, factory) {
	...
	(factory((global.waitwindow = {}),global.React));
	...
	*/
	class WaitWindow extends React.Component {
	    ...
	    get id() {
	        if (!this._id) {
	            this._id = 'WaitWindow' + Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
	        }
	        return this._id;
	    }
	  ...
	  */
	    ...
	    */
	    ...
	    render() {
	        return (React.createElement("smart-wait-window", { ref: this.componentRef }, this.props.children));
	    }
	}

	exports.Smart = Smart;
	exports.WaitWindow = WaitWindow;
	exports.default = WaitWindow;
