...
(function (global, factory) {
	...
	(factory((global.dialogwindow = {}),global.React));
	...
	*/
	class DialogWindow extends React.Component {
	    ...
	    get id() {
	        if (!this._id) {
	            this._id = 'DialogWindow' + Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
	        }
	        return this._id;
	    }
	  ...
	  */
	    ...
	    */
	    ...
	    render() {
	        return (React.createElement("smart-dialog-window", { ref: this.componentRef }, this.props.children));
	    }
	}
