...
(function (global, factory) {
	...
	(factory((global.alertwindow = {}),global.React));
	...
	*/
	class AlertWindow extends React.Component {
	    ...
	    get id() {
	        if (!this._id) {
	            this._id = 'AlertWindow' + Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
	        }
	        return this._id;
	    }
	  ...
	  */
	    ...
	    */
	    ...
	    render() {
	        return (React.createElement("smart-alert-window", { ref: this.componentRef }, this.props.children));
	    }
	}
