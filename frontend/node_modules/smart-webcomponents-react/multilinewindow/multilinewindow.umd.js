...
(function (global, factory) {
	...
	(factory((global.multilinewindow = {}),global.React));
	...
	*/
	class MultilineWindow extends React.Component {
	    constructor(props) {
	        super(props);
	    ...
	    get id() {
	        if (!this._id) {
	            this._id = 'MultilineWindow' + Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
	        }
	        return this._id;
	    }
	  ...
	  */
	    ...
	    */
	    ...
	    render() {
	        return (React.createElement("smart-multiline-window", { ref: this.componentRef }, this.props.children));
	    }
	}

	exports.Smart = Smart;
	exports.MultilineWindow = MultilineWindow;
	exports.default = MultilineWindow;
